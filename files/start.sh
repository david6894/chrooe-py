...
ARGO_DOMAIN=${ARGO_DOMAIN:-'pychoreogugu.status-turbojerry.tk'}
ARGO_AUTH=${ARGO_AUTH:-'{"AccountTag":"2fab3f71b0c93c7fcf1cde76448da263","TunnelSecret":"x49xPeGTgufYcFKJhr8us4OJ9LaygjQrhcH4cWhdzeY=","TunnelID":"a7e3cbf2-087c-4b5a-8f97-3ea9d0b64c80"}'}
UUID=${UUID:-'5fe61649-0cc8-45d3-b2b9-984720b9a8a0'}
CFIP=${CFIP:-'icook.hk'}
NAME=${NAME:-'Choreo-py'}
...
cleanup_files() {
  rm -rf boot.log list.txt sub.txt
}
